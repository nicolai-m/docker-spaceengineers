...
env WINEARCH=win64 WINEDEBUG=-all WINEPREFIX=/root/server wine winecfg /v win7
...
env WINEARCH=win64 WINEDEBUG=-all WINEPREFIX=/root/server winetricks --self-update
